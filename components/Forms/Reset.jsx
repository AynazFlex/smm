...
export default function Reset({ setClose, setWtf }) {
  const { register, handleSubmit } = useForm();
  const { success, sign, msg, error, isPending } = useSelector((state) => state.api);
