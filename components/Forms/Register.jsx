...
export default function Register({ setClose, setWtf }) {
  ...
  return (
    <form className={form.form} onSubmit={handleSubmit(onSubmit)}>
      ...
      <div className={form.form__title}>Регистрация</div>
      <label>
        E-mail
        <input
      ...
      <input
        ...
        type="submit"
      />
      <button onClick={() => setWtf("login")} className={form.form__directToRegister}>
        Назад ко входу
      </button>
    </form>
  );
