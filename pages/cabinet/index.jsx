...
export default function Profile() {
  ...
  const { isAuth, email } = useSelector(state => state.api)
              ...
              <div className="container__elem container__elem--12 container__elem--df container__elem--jcsb">
                ...
                <div className="zakazi__right">
                  <div className="zakaziTabs">
                      ...
                      <div className="zakaziTab__ico">
                        ...
                        >
                          <g clipPath="url(#clip0_1317_4203)">
                            <path
                              d="M3 19.5002C4.36817 18.7103 5.92017 18.2944 7.5 18.2944C9.07983 18.2944 10.6318 18.7103 12 19.5002C13.3682 18.7103 14.9202 18.2944 16.5 18.2944C18.0798 18.2944 19.6318 18.7103 21 19.5002"
                              stroke="#B0B0B0"
                              strokeWidth="2"
                              strokeLinecap="round"
                            ...
                            />
                            <path
                              d="M3 6.49972C4.36817 5.7098 5.92017 5.29395 7.5 5.29395C9.07983 5.29395 10.6318 5.7098 12 6.49972C13.3682 5.7098 14.9202 5.29395 16.5 5.29395C18.0798 5.29395 19.6318 5.7098 21 6.49972"
                              stroke="#B0B0B0"
                              strokeWidth="2"
                              strokeLinecap="round"
                              strokeLinejoin="round"
                    ...
                    <button
                      onClick={() => setBlock("history")}
                      type="button"
                      className={`zakaziTab${
                        block === "history" ? " active" : ""
                      }`}
                    >
                      <div className="zakaziTab__ico">
                        <svg
                        ...
                        >
                          <path
                            d="M12 10.25C10.7574 10.25 9.75 11.2574 9.75 12.5C9.75 13.7426 10.7574 14.75 12 14.75C13.2426 14.75 14.25 13.7426 14.25 12.5C14.25 11.2574 13.2426 10.25 12 10.25ZM8.25 12.5C8.25 10.4289 9.92893 8.75 12 8.75C14.0711 8.75 15.75 10.4289 15.75 12.5C15.75 14.5711 14.0711 16.25 12 16.25C9.92893 16.25 8.25 14.5711 8.25 12.5Z"
                            fill="#B0B0B0"
                          />
                          <path
                            d="M5 7.25C4.30964 7.25 3.75 7.80964 3.75 8.5V16.5C3.75 17.1904 4.30964 17.75 5 17.75H19C19.6904 17.75 20.25 17.1904 20.25 16.5V8.5C20.25 7.80964 19.6904 7.25 19 7.25H5ZM2.25 8.5C2.25 6.98122 3.48122 5.75 5 5.75H19C20.5188 5.75 21.75 6.98122 21.75 8.5V16.5C21.75 18.0188 20.5188 19.25 19 19.25H5C3.48122 19.25 2.25 18.0188 2.25 16.5V8.5Z"
                            fill="#B0B0B0"
                          />
                          <path
                            d="M17.25 12.5C17.25 12.0858 17.5858 11.75 18 11.75H18.01C18.4242 11.75 18.76 12.0858 18.76 12.5C18.76 12.9142 18.4242 13.25 18.01 13.25H18C17.5858 13.25 17.25 12.9142 17.25 12.5Z"
                            fill="#B0B0B0"
                          />
                          <path
                            d="M5.25 12.5C5.25 12.0858 5.58579 11.75 6 11.75H6.01C6.42421 11.75 6.76 12.0858 6.76 12.5C6.76 12.9142 6.42421 13.25 6.01 13.25H6C5.58579 13.25 5.25 12.9142 5.25 12.5Z"
                            fill="#B0B0B0"
                          />
                        </svg>
                      </div>
