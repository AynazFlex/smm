  ...
  return (
    <div className={order.zakaz}>
      ...
      <div className={order.zakaz__bottom}>
        ...
        <a href="https://t.me/+38-LLhCR6xFlMmVl" target="_blank" className={order.zakaz__bottom_link}>Получить промокод</a>
            ...
            <form onSubmit={handleSubmit} className={order.form}>
              ...
              <label>
                ...
                <div className={order.promo_link}>
                    ...
                    <a href="https://t.me/+38-LLhCR6xFlMmVl" target="_blank">Получить промокод</a>
                </div>
                <input
                  value={promocode}
