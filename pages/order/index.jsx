  ...
  return (
    <div className={order.zakaz}>
      ...
      <div className={order.zakaz__body}>
        Подписываются живые люди со всего мира.
        Все отписки и списания мы будем восстанавливать автоматически в течение 60 дней после заказа.
      </div>
      <div className={order.zakaz__midlle}>
        <div className={order.zakaz__midlle_item}>
            🌍
            Со всего мира
        </div>
        <div className={order.zakaz__midlle_item}>
            🚀
            Скорость до 10К/день
        </div>
        <div className={order.zakaz__midlle_item}>
            ⚡
            Быстрый старт
      ...
      <div className={order.zakaz__bottom}>
        <div className={order.zakaz__bottom_top}>
            Скидки <span>до 50%</span><br />
            в нашем телеграм-канале
        </div>
        <div className={order.zakaz__bottom_text}>
            Раздаем промокоды в Telegram каждую неделю
        </div>
        <a href="https://t.me/+38-LLhCR6xFlMmVl" target="_blank" rel="noreferrer" className={order.zakaz__bottom_link}>Получить промокод</a>
        <img src="img/design/telega_zakaz.png" alt="" className={order.zakaz__bottom_img1} />
        <img src="img/design/telega_zakaz1.png" alt="" className={order.zakaz__bottom_img2} />
      </div>
    </div>
  );
};
            ...
            <form onSubmit={handleSubmit} className={order.form}>
              ...
              >
                ...
                >
                  ...
                  <button
                    className={open === "tarif" ? order.form__select_open : ""}
                    type="button"
                  >
                    <svg
                      width="17"
                ...
                {open === "tarif" && (
                  ...
                  >
                    <div
                      onMouseEnter={() =>
                        setZakaz({ tarif_name: "Русские", tarif_label: "ХИТ" })
                      }
                    ...
                    <div
                      ...
                      onMouseEnter={() =>
                        setZakaz({ tarif_name: "Из Ирана 🇮🇷", tarif_label: "" })
                      }
                      className={`${order.form__label_dropdown_item} ${order.form__label_dropdown_jcsb}`}
                    >
                      Из Ирана 🇮🇷
              ...
              <input
                disabled={!(soc_network && tarif && service && url && quantity)}
